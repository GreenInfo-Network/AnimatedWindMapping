...
*/ 
  ...
  var VELOCITY_SCALE = 1/700000;             // scale for wind velocity (completely arbitrary--this value looks nice)
  var INTENSITY_SCALE_STEP = 10;            // step size of particle intensity color scale
  var MAX_WIND_INTENSITY = 40;              // wind velocity at which particle intensity is maximum (m/s)
  var MAX_PARTICLE_AGE = 100;                // max number of frames a particle is drawn before regeneration
  var PARTICLE_LINE_WIDTH = 1.8;              // line width of a drawn particle
  var PARTICLE_MULTIPLIER = 2;              // particle count scalar (completely arbitrary--test)
  var PARTICLE_REDUCTION = 0.05;            // reduce particle count to this much of normal for mobile devices
...
*/
          /*"rgba(64, 0, 75,0.5)",
          "rgba(118, 42, 131,0.5)",
          "rgba(153, 112, 171,0.5)",
          "rgba(194, 165, 207,0.5)",
          "rgba(231, 212, 232,0.5)",
          "rgba(247, 247, 247,0.5)",
          "rgba(217, 240, 211,0.5)",
          "rgba(166, 219, 160,0.5)",
          "rgba(90, 174, 97,0.5)",
          "rgba(27, 120, 55,0.5)",
          "rgba(0, 68, 27,0.5)"  */       
          //"rgba(" + hexToR('#ff0000') + ", " + hexToG('#ff0000') + ", " + hexToB('#ff0000') + ", " + 0.5 + ")",
          /* white-ish
          "rgba(" + hexToR('#ffffff') + ", " + hexToG('#ffffff') + ", " + hexToB('#ffffff') + ", " + 0.1 + ")",
          "rgba(" + hexToR('#ffffff') + ", " + hexToG('#ffffff') + ", " + hexToB('#ffffff') + ", " + 0.2 + ")",
          "rgba(" + hexToR('#ffffff') + ", " + hexToG('#ffffff') + ", " + hexToB('#ffffff') + ", " + 0.3 + ")",
          "rgba(" + hexToR('#ffffff') + ", " + hexToG('#ffffff') + ", " + hexToB('#ffffff') + ", " + 0.4 + ")",
          "rgba(" + hexToR('#ffffff') + ", " + hexToG('#ffffff') + ", " + hexToB('#ffffff') + ", " + 0.5 + ")",
          "rgba(" + hexToR('#ffffff') + ", " + hexToG('#ffffff') + ", " + hexToB('#ffffff') + ", " + 0.6 + ")",
          "rgba(" + hexToR('#ffffff') + ", " + hexToG('#ffffff') + ", " + hexToB('#ffffff') + ", " + 0.7 + ")",
          "rgba(" + hexToR('#ffffff') + ", " + hexToG('#ffffff') + ", " + hexToB('#ffffff') + ", " + 0.8 + ")",
          "rgba(" + hexToR('#ffffff') + ", " + hexToG('#ffffff') + ", " + hexToB('#ffffff') + ", " + 0.9 + ")",
        ...
        */
        ...
        result = [];
        //var start_hue = 0.3; // 0.33 = g, 0.67 = b
        var start_hue = 2 * Math.PI/3; // 2π/3 = g, 4π/3 = b; g = 
        for (var i = 0; i < 11; i++) {
            //h = i*2*Math.PI/11;
            //h = start_hue + i * 0.027; // = 0.3 / 11
            h = start_hue + i * 3.52/11; // = 120 / 11
            //console.log(h);
            rgb_arr = interpolate(h,1,0.5);
            //rgb_arr = interpolate(h,1,1);
            r = parseInt(rgb_arr[0]);
            g = parseInt(rgb_arr[1]);
            b = parseInt(rgb_arr[2]);
            //rgba_str = "rgba(" + r + ", " + g + ", "+ b + ", 0.5)";
            rgba_str = "rgba(" + r + ", " + g + ", "+ b + ", 0.7)";
    ...
    var fadeFillStyle = "rgba(0, 0, 0, 0.90)";
